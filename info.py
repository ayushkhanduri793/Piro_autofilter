...
REQ_PICS = (environ.get('REQ_PICS', 'https://graph.org/file/62db4a1093fe9a18bbe78.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'master793')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '<b>🧿 ᴛɪᴛᴛʟᴇ :  {title} \n🌟 ʀᴀᴛɪɴɢ : {rating} \n🎭 ɢᴇɴʀᴇ : {genres} \n📆 ʀᴇʟᴇᴀsᴇ : {year} \n🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒</b> [[𝐌𝐀𝐒𝐓𝐄𝐑𝟕𝟗𝟑]](t.me/master793)')
